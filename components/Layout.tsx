...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  return (
    <div className="min-h-screen bg-slate-100 text-slate-800 font-sans selection:bg-hazard selection:text-black">
      ...
      <header className="border-b border-slate-200 bg-white/85 backdrop-blur-md sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-display font-bold uppercase tracking-wider text-slate-950">
                Product Concept <span className="text-hazard">Studio</span>
              </h1>
              <p className="text-xs text-slate-500 font-mono tracking-widest uppercase">AI Product Idea Generator</p>
            </div>
          </div>
      ...
      <footer className="border-t border-slate-200 mt-12 py-8 text-center text-slate-500 text-sm font-mono">
